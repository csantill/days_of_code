...
cdc.state.data$Year<- as.character(cdc.state.data$Year)
cdc.state.data$YearMonth <- paste(cdc.state.data$Year , cdc.state.data$Month.Code,sep="-")
...
# cdc.state.data <- left_join(cdc.state.data,state.geom,by=c('State'='name'))
# cdc.state.data <- cdc.state.data %>% select(
