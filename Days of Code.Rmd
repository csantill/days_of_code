...
cdc.state.data <- left_join(cdc.state.data,states_geom,by=c('State'='name'))
cdc.state.data <- subset(cdc.state.data,select=c("State","YearMonth","Year","Month.Code","Deaths","latitude","longitude"))
