...
cdcAnnualData        <- read_tsv("CDC/data/statefull_annual2.txt")
...
cdcAnnualData <- cdcAnnualData %>% select(State,Year,Deaths,Population,Crude.Rate,Age.Adjusted.Rate,Lat=latitude,Long=longitude)
